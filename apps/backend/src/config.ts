...
const envSchema = z.object({
    ...
    CANTARA_DAML_LEDGER_ID: z.string().default("participant1"),
    ...
    CANTARA_DAML_INSTITUTION_TOKEN: z.string().optional(),
...
export function loadBackendConfigFromEnv(): BackendConfig {
    ...
    return {
        ...
        damlInstitutionToken: env.CANTARA_DAML_INSTITUTION_TOKEN,
